...
void inputDetection(GLFWwindow* window, GLfloat* vertices, double* xVel, double* yVel, float* length, float* currentAngle, double* angleA, double* angleB){
...
int main(){
    ...
    while (!glfwWindowShouldClose(window)) {
		...
		inputDetection(window, vertices, &xVel, &yVel, &length, &currentAngle, &angleA, &angleB);
